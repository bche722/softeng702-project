...
public class DemoActivity extends AppCompatActivity {
    public enum Tasks {Keyboard, Numpad, Wikipedia, Draw, RandomBtn, BigImage, TextEditor}
    ...
    public static final String[] TASKS = new String[]{/*Tasks.Keyboard.name(), Tasks.Numpad.name(), Tasks.Wikipedia.name(), */Tasks.Draw.name(), /*Tasks.RandomBtn.name(), */Tasks.BigImage.name(),Tasks.TextEditor.name()};
