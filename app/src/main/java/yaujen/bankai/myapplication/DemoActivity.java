...
public class DemoActivity extends AppCompatActivity {
    public enum Tasks {Draw, RandomBtn, BigImage, TextEditor, Calculator}
    ...
    public String[] CLICKING_METHODS = new String[]{ClickingMethod.VOLUME_DOWN.name(), ClickingMethod.BACK_TAP.name()};
    public static final String[] TASKS = new String[]{Tasks.Draw.name(), Tasks.BigImage.name(),Tasks.TextEditor.name(),Tasks.Calculator.name()};
    ...
    private void onStartButton() {
        ...
        }else if(task.equals(Tasks.TextEditor.name())){
            myIntent = new Intent(DemoActivity.this, TextEditorActivity.class);
        }else if(task.equals(Tasks.Calculator.name())){
            myIntent = new Intent(DemoActivity.this, CalculatorActivity.class);
        }
